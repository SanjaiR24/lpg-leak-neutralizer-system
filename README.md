...
Detected leaks reliably within seconds of onset, across repeated trials
MOSFET switching operated silently with no mechanical delay
Reaction-timing graph (see output/reaction_timing_graph.png) shows buzzer, solenoid valve, and exhaust fan all activating together once concentration crosses the 250 ppm threshold, and turning off as concentration falls back into the safe zone
Stable, low-power operation suitable for continuous domestic/industrial use
